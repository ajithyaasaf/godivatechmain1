        ...
        <AnimatePresence>
          {isMenuOpen && (
            ...
            >
              ...
              {/* Main navigation links - improved height and spacing */}
                    ...
                    >
                      {!item.hasMegaMenu ? (
                        ...
                        <div className="mb-8">
                          ...
                          {/* Services grid layout with improved spacing */}
              ...
              {/* Enhanced footer area with CTA and socials */}
              <motion.div 
                className="py-8 px-6 border-t border-white/10 mt-auto"
                initial={{ y: 20, opacity: 0 }}
                animate={{ y: 0, opacity: 1 }}
                transition={{ delay: 0.5 }}
              >
                <div className="text-center mb-6">
                  <p className="text-white/70 text-sm mb-2">Ready to start your next project?</p>
                  <h3 className="text-xl font-semibold text-white">Let's work together!</h3>
                </div>
                
                <Button
                  asChild
                  className="w-full bg-white text-primary hover:bg-white/90 rounded-full py-7 shadow-lg font-medium text-lg"
                  onClick={() => setIsMenuOpen(false)}
                >
                ...
                <div className="mt-8 pt-5 border-t border-white/10">
                  <p className="text-white/50 text-sm text-center mb-4">Connect with us</p>
