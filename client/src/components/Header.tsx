  ...
  return (
    <>
      ...
      >
        ...
        {/* Mobile navigation with simplified design */}
        <AnimatePresence>
          {isMenuOpen && (
            <motion.div 
            ...
            >
              <motion.div 
                className="fixed inset-y-0 right-0 w-[85%] max-w-sm bg-white shadow-2xl flex flex-col"
                initial={{ x: "100%" }}
                animate={{ x: 0 }}
                exit={{ x: "100%" }}
                transition={{ type: "spring", damping: 25, stiffness: 300 }}
              ...
              >
                ...
                {/* Navigation container - simplified for better display */}
                      ...
                      <div key={item.path} className="border-b border-gray-100">
                        ...
                        >
                          ...
                          <span className="mr-3 text-gray-500">
                            ...
                            {item.label === "Services" && <Layers className="h-5 w-5" />}
                        ...
                        {/* Services submenu with simplified styling */}
                        {item.hasMegaMenu && (
                          <div className="bg-gray-50 py-2">
                            {serviceItems.map((service, idx) => (
                              <Link 
                                key={idx}
                                href={service.path}
                                className="flex items-center px-7 py-2 text-gray-700 hover:text-primary"
                                onClick={() => setIsMenuOpen(false)}
                              >
                                <service.icon className={`h-4 w-4 ${service.color} mr-3`} />
                ...
                <div className="p-4 border-t border-gray-200 bg-gray-50">
                  ...
                  <div className="mt-4 pt-3 border-t border-gray-200 flex justify-center space-x-6">
