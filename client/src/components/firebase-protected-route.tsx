...
/**
 * A component that protects routes requiring authentication with Firebase Auth
...
export const FirebaseProtectedRoute = ({ 
  ...
  // Render function for protected content
  ...
  // If no path provided, just render directly (for use with Route component)
  if (!path) {
    return renderProtectedContent();
  }

  // If path is provided, wrap in a Route
  return (
    <Route path={path}>
