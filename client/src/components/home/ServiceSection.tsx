...
const ServiceCard: React.FC<{ service: Service; index: number }> = ({
  ...
  return (
    <div className="group relative">
      ...
      <div
        className="absolute inset-0 bg-gradient-to-br from-blue-50 to-indigo-100 rounded-2xl 
      ...
      >
        ...
        <div className="flex items-center justify-between mb-6">
          <div
            className="w-16 h-16 bg-gradient-to-br from-blue-500 to-indigo-600 rounded-xl 
  ...
  const defaultServices: Service[] = [
    {
      ...
      description:
        "Create affordable, responsive websites for your business that work on all devices and help your brand stand out online.",
      icon: Globe,
    ...
    },
    {
      ...
      description:
        "Boost your online presence with our comprehensive digital marketing strategies including SEO, social media management, and online advertising.",
      icon: Megaphone,
    ...
    },
    {
      ...
      description:
        "Build custom mobile applications for Android and iOS platforms that connect you with your customers wherever they are.",
      icon: Smartphone,
    ...
    },
    {
      ...
      title: "Poster Design",
      description:
        "Craft eye-catching posters and marketing materials that effectively communicate your message and attract customer attention.",
      icon: PenTool,
      slug: "poster-design",
      features: [
        "Creative Design",
    ...
    },
    {
      ...
      title: "UI/UX Design",
      description:
        "Create intuitive and engaging user interfaces that provide exceptional user experiences and keep customers coming back.",
      icon: Layout,
      slug: "ui-ux-design",
    ...
    },
    {
      ...
      description:
        "Develop a distinctive visual identity with professional logo design and comprehensive branding that communicates your company values.",
      icon: Palette,
      ...
      <div className="container mx-auto px-4">
        ...
        <div className="text-center mb-16">
          ...
          <h2 className="text-4xl md:text-5xl font-bold text-gray-800 mb-6">
            Professional <span className="text-blue-600">IT Solutions</span> for
            Your Business
          </h2>

          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            From web development to digital marketing, we provide comprehensive
            technology services to help businesses in Madurai establish a strong
            online presence.
          </p>
        </div>
        ...
        <div className="text-center">
          <div className="bg-white rounded-2xl shadow-lg p-8 max-w-4xl mx-auto">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              <Link href="/portfolio">
                <button
                  className="border-2 border-blue-600 text-blue-600 px-8 py-3 rounded-xl 
