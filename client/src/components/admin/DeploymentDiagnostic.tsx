  ...
  return (
    <Card className="w-full max-w-4xl mx-auto">
      <CardHeader>
        ...
        <CardDescription>
          Troubleshooting tool to diagnose Vercel deployment issues
        </CardDescription>
      </CardHeader>
      <CardContent>
                ...
                <AccordionItem value="item-1">
                  ...
                  <AccordionContent>
                    <ul className="list-disc pl-5 space-y-2">
                      <li>Ensure Firebase configuration is set in Vercel environment variables</li>
                      <li>Check CORS settings in backend server to allow Vercel domain</li>
                      <li>Verify API endpoints are accessible from Vercel deployment</li>
