...
const Portfolio = () => {
  ...
  useEffect(() => {
    const fetchProjects = async () => {
      try {
        ...
        // Create a query to get projects from Firestore, ordered by title
  ...
  // Default projects in case Firestore doesn't return data
  const defaultProjects = [
    {
      id: 1,
      title: "E-Commerce Platform Redesign",
      description:
        "Completely redesigned the online shopping experience for a leading retailer, resulting in a 40% increase in conversions.",
      image:
    ...
    },
    {
      ...
      description:
        "Migrated a healthcare provider's legacy systems to a secure cloud infrastructure, improving performance by 60%.",
      image:
    ...
    },
    {
      ...
      description:
        "Developed an AI-powered system for a manufacturing company that predicts equipment failures before they occur.",
      image:
    ...
    },
    {
      ...
      description:
        "Created a secure mobile banking application with advanced features like biometric authentication and real-time notifications.",
      image:
    ...
    },
    {
      ...
      description:
        "Designed and implemented a custom ERP solution that integrated all departments and streamlined business processes.",
      image:
    ...
    },
    {
      ...
      description:
        "Strengthened a financial institution's security posture with advanced threat detection and prevention systems.",
      image:
  ...
  const displayProjects =
    error || (projects.length === 0 && !isLoading) ? defaultProjects : projects;
                ...
                <LazyMotion features={domAnimation}>
                  ...
                  >
                    <span className="font-medium">
                      Delivering excellence across {categories.length - 1}{" "}
                ...
                {categories.map((category, index) => (
                  <motion.button
                    ...
                    className={`py-2 px-6 rounded-full text-sm font-medium transition-all duration-300 ${
                      (category === "All" && activeFilter === null) ||
            ...
            <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
              ...
              >
                ...
                <p className="text-lg text-neutral-600 max-w-2xl mx-auto">
                  We follow a proven approach to ensure successful project
